...
public class LatestAdapterLV extends RecyclerView.Adapter<LatestAdapterLV.ViewHolder> {
    ...
    public LatestAdapterLV(Activity activity, List<SubCategoryList> subCategoryLists,String type) {
