...
public class SearchAdapterGV extends RecyclerView.Adapter<SearchAdapterGV.ViewHolder> {
    ...
    public SearchAdapterGV(Activity activity, List<SubCategoryList> subCategoryLists) {
